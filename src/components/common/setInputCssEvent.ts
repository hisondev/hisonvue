...
export const removeInputTextCssEvent = (el: HTMLInputElement) => {
  ...
  el.removeEventListener('touchcancel', onTouchcancel, { capture: true } as any)
  el.classList.remove('hison-input-on-mouseover')
}
...
export const removeInputCssEvent = (el: HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement) => {
  ...
  el.classList.remove('hison-input-on-active')
  el.classList.remove('hison-input-on-mouseover')
}
