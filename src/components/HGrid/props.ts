...
import { SelectionPolicy, GridDateFormat, GridMonthFormat, GridVerticalAlign, SelectionPolicyValue, SELECTION_POLICY_VALUES, ColorSet, COLOR_SET_VALUES, isCssColorLike, GRID_VERTICAL_ALIGN_VALUES, GridVerticalAlignValue, GRID_MONTH_FORMAT_VALUES, GridMonthFormatValue, GridDateFormatValue, GRID_DATE_FORMAT_VALUES } from "../../enums";
...
export const gridProps = {
    ...
    lockedColor: { type: Boolean, default: true },
    ...
    redoable: { type: Boolean, default: true },

    /* The number of times the grid edit state is recorded for undo and redo. */
    redoCount: { type: Number, required: false },
    ...
    rownumVisible: { type: Boolean, default: true },
    ...
    rownumLockedColor: { type: Boolean, default: false },
    ...
    statusLockedColor: { type: Boolean, default: false },

    /* The user selection range policy of the grid. 'range': range selection, 'single': single cell selection, 'none': no selection) */
    selectionPolicy: {
        type: String as PropType<SelectionPolicy | SelectionPolicyValue>,
        required: false,
        validator: (v: any) => (SELECTION_POLICY_VALUES as readonly string[]).includes(v),
    },
     ...
     */
    dateFormat: {
        type: String as PropType<GridDateFormat | GridDateFormatValue>,
        required: false,
        validator: (v: any) => (GRID_DATE_FORMAT_VALUES as readonly string[]).includes(v),
    },
     ...
     */
    monthFormat: {
        type: String as PropType<GridMonthFormat | GridMonthFormatValue>,
        required: false,
        validator: (v: any) => (GRID_MONTH_FORMAT_VALUES as readonly string[]).includes(v),
    },

    /* Sets the alter-row of the grid (the function that alternates the colors of each row). */
    alterRow: { type: Boolean, default: true },
     ...
     */
    frozenColCount: { type: Number, required: false },

    /* Sets the frozen rows of the grid. */
    frozenRowCount: { type: Number, required: false },
    ...
    allCheckable: { type: Boolean, default: true },
    ...
    sizeLevel: { type: Number, required: false },

    /* Sets the default vertical-align of the grid cell. Choose from 'top', 'center', 'bottom'. */
    verticalAlign: {
        type: String as PropType<GridVerticalAlign | GridVerticalAlignValue>,
        required: false,
        validator: (v: any) => (GRID_VERTICAL_ALIGN_VALUES as readonly string[]).includes(v),
    },
    ...
    color: {
        type: String as PropType<ColorSet | string>,
        required: false,
        validator: (v: any) =>
        (COLOR_SET_VALUES as readonly string[]).includes(v) || isCssColorLike(v),
    },
