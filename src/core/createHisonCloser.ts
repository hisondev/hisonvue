...
export const createHisonCloser = (hisonConfig: HisonConfig) => {
  ...
  hisonCloser.componentStyle = {
    ...
    custom1Color : hisonConfig.componentStyle.custom1Color,
    custom2Color : hisonConfig.componentStyle.custom2Color,
    custom3Color : hisonConfig.componentStyle.custom3Color,
    custom4Color : hisonConfig.componentStyle.custom4Color,
    custom5Color : hisonConfig.componentStyle.custom5Color,
    invertColor : hisonConfig.componentStyle.invertColor,
    minHeightXS: hisonConfig.componentStyle.minHeightXS,
    ...
    fontSizeXS: hisonConfig.componentStyle.fontSizeXS,
    ...
    custom1InvertColor: null,
    custom2InvertColor: null,
    custom3InvertColor: null,
    custom4InvertColor: null,
    custom5InvertColor: null,
